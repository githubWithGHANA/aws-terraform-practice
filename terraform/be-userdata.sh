...
# --------------------------------------------------
aws s3 cp s3://nit-dev-be-app-bucket/datastore-0.0.7.jar .
...
MYSQL_HOST=jdbc:mysql://$MYSQL_HOST:3306/datastore?createDatabaseIfNotExist=true \
